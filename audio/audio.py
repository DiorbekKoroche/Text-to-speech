...
def download():
    ...
    if (text):
        if (speed =="Fast"):
            ...
            setvoice()   
#icon
image_icon = PhotoImage(file="audio/icons8-speaker-50.png")
...
Logo=PhotoImage(file="audio/icons8-microphone-50.png")
Label(Top_frame,image=Logo,bg="#00FFF7").place(x=40,y=20)
...
imageicon=PhotoImage(file="audio/icons8-speaker-50.png")
btn=Button(root,text="Speak",compound=LEFT,image=imageicon,width=130,bg="#39c790",font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)

imageicon2=PhotoImage(file="audio/icons8-downlod-64.png")
